        ...
        public Time(int hours, int minutes, int seconds)
        {
            if (hours < 0 || hours > 23)
            {
                throw new ArgumentOutOfRangeException
                    (nameof(hours), "Часы должны быть в диапазоне от 0 до 23.");
            }
            
            if (minutes < 0 || minutes > 59)
            {
                throw new ArgumentOutOfRangeException
                   (nameof(minutes), "Минуты должны быть в диапазоне от 0 до 59.");
            }
   
            if (seconds < 0 || seconds > 59)
            {
                throw new ArgumentOutOfRangeException
                   (nameof(seconds), "Секунды должны быть в диапазоне от 0 до 59.");
            }
