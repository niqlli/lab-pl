...
let rec foldTree tree =
    let rec helper tree acc =
        ...
        | Node(value, left, right) ->
            ...
            let newAcc =
                if leftIsLeaf && rightIsLeaf then acc
                elif leftIsLeaf && not rightIsLeaf then value :: acc
                elif not leftIsLeaf && rightIsLeaf then value :: acc
                else acc 
            helper right (helper left newAcc) 
